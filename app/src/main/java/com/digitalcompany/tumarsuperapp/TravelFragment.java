...
public class TravelFragment extends Fragment {
    ...
    private void loadHardcodedTours() {
        ...
        allTours.add(new TourCard("Анталья, Турция", "Concorde De Luxe Resort", 5,
                ...
                "https://ht.kz/findtours?country=1&region=8&departCity=1&adult=2&daysFrom=7&daysTo=14&stars=any"));
        allTours.add(new TourCard("Дубай, ОАЭ", "Atlantis The Palm", 5,
                ...
                "https://ht.kz/findtours?country=2&departCity=1&adult=2&daysFrom=5&daysTo=10&stars=any"));
        allTours.add(new TourCard("Пхукет, Таиланд", "Sala Phuket Resort", 5,
                ...
                "https://ht.kz/findtours?country=3&region=16&departCity=1&adult=2&daysFrom=10&daysTo=14&stars=any"));
        allTours.add(new TourCard("Мальдивы", "COMO Cocoa Island", 5,
                ...
                "https://ht.kz/findtours?country=9&departCity=1&adult=2&daysFrom=7&daysTo=14&stars=any"));
        allTours.add(new TourCard("Хургада, Египет", "Steigenberger Al Dau", 5,
                ...
                "https://ht.kz/findtours?country=18&region=197&departCity=1&adult=2&daysFrom=7&daysTo=14&stars=any"));
        allTours.add(new TourCard("Бали, Индонезия", "Four Seasons Bali", 5,
                ...
                "https://ht.kz/findtours?country=19&departCity=1&adult=2&daysFrom=10&daysTo=14&stars=any"));
        allTours.add(new TourCard("Барселона, Испания", "Hotel Arts Barcelona", 5,
                ...
                "https://ht.kz/findtours?country=14&departCity=1&adult=2&daysFrom=7&daysTo=10&stars=any"));
        allTours.add(new TourCard("Паттайя, Таиланд", "Dusit Thani Pattaya", 5,
                ...
                "https://ht.kz/findtours?country=3&region=15&departCity=1&adult=2&daysFrom=10&daysTo=14&stars=any"));
        allTours.add(new TourCard("Амальфи, Италия", "Belmond Hotel Caruso", 5,
                ...
                "https://ht.kz/findtours?country=13&departCity=1&adult=2&daysFrom=7&daysTo=10&stars=any"));
        allTours.add(new TourCard("Шарм-эш-Шейх", "Four Seasons Sharm", 5,
                ...
                "https://ht.kz/findtours?country=18&region=169&departCity=1&adult=2&daysFrom=7&daysTo=14&stars=any"));
